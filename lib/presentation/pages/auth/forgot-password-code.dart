import 'package:bloc_login/data/shared_preference.dart';
                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                initialValue: arguments['random'].toString()??"",
                                style: const TextStyle(
                                    color: Colors.white, fontFamily: 'UniNeue'),
                                validator: (val) => validateCode(val,arguments['random'].toString()),
                                controller: null,
                                    ...
                                    if(_fgtCodeForm.currentState.validate())
                                      {
                                        ...
                                        String uEmail = await CacheHelper.getUserNameFromSharedPreference();
                                        Navigator.of(context).pushNamed('/forgot-password/update-password',arguments: uEmail);
                                      }
