              ...
              child: SingleChildScrollView(
                  child: BlocConsumer<AuthSharedBloc, AuthState>(
                    listener: (context,state){
                      if(state is UpdatePasswordGranted)
                        {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                style: const TextStyle(
                                    color: Color(0xFF0093CD), fontFamily: 'UniNeue'),
                                validator: (val) => confirmPassword(pwdController.text, cpwdController.text),
                            ...
                            Padding(
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    {
                                      BlocProvider.of<AuthSharedBloc>(context).add(UpdatePasswordRequested(pwdController.text));
